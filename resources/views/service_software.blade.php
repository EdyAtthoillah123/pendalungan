        ...
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div class="col-md-6 col-lg-6 txt-primary">
                    <h1 class="fira-sans-bold txt-primary">Software House</h1>
                    <h6 class="fira-sans-bold txt-primary">Sekilas Tentang Software House</h6>
                    <p class="txt-primary fira-sans-regular">Temukan kemampuan luar biasa dalam penyiaran dan streaming
                        dengan koleksi peralatan berkualitas kami. Mulai petualangan visual Anda sekarang!
                        Temukan kemampuan luar biasa dalam penyiaran dan streaming dengan koleksi peralatan berkualitas
                        kami. Mulai petualangan visual Anda sekarang!
                    </p>
                    <p>Temukan kemampuan luar biasa dalam penyiaran dan streaming dengan koleksi peralatan berkualitas
                        kami.</p>
                </div>
                <div class="col-md-6 col-lg-6">
                    <div class="jumbotron_img">
                        <img src="{{ asset('images/software_service/business-team.png') }}" class="img-fluid" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <footer id="contact" style="background-color: #121212; position: relative;">
        <div class="container">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-9 mt-4 mb-4">
                                    <h3 class="card-title fira-sans-bold">Bekerja Bersama dengan Pendalungan</h3>
                                    <p class="card-text" style="margin-top: 12px;">Perusahaan kami adalah perusahaan
                                        profesional, dengan layanan efektif dan tim expert yang bisa diandalkan</p>
                                </div>
                                <div class="col-md-3  mt-4">
                                    <button class="custom-button">Konsultasikan Bisnismu</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4  text-center hide-on-small-screen" style="margin-top: 240px;">
