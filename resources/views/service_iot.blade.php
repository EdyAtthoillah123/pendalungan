        ...
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div class="col-md-6 col-lg-6 txt-primary">
                    <h1 class="fira-sans-bold txt-primary">Internet of Things</h1>
                    <h6 class="fira-sans-bold txt-primary">Sekilas Tentang Internet of Things</h6>
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="jumbotron_img">
                        <img src="{{ asset('images/software_service/iot.png') }}" class="img-fluid" alt="">
                    </div>
                </div>
            </div>
        </div>
